            ...
            <div className="space-y-3.5 text-xs sm:text-sm">
              <div className="bg-gray-800/60 p-3 rounded-lg border border-gray-800">
                <span className="font-bold text-[#F2B852] block text-xs uppercase tracking-wide">
                  {language === "en" ? "Sunday 1:00 PM" : "Dimanche 13h00"}
                </span>
                <span className="text-white font-medium">
                  {language === "en"
                    ? "Main Celebration & Worship"
                    : "Culte Principal de Célébration"}
                </span>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="text-[11px] text-gray-400 block font-semibold">
                    {language === "en" ? "Mailing Address" : "Adresse postale"}
                  </span>
                  <span>1340 rue des Adages Québec (Québec) G3K0T2 Canada</span>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="text-[11px] text-gray-400 block font-semibold">
                    {language === "en" ? "Worship Location" : "Lieu de culte"}
                  </span>
                  <span>2401 avenue de l'abbé Giguere, Québec, QC G1C 0H4</span>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 border-t border-gray-800/80 text-xs text-gray-500 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <p>
            ...
            {language === "en"
              ? "Bethany Christian Community"
              : "Communauté Chrétienne Béthanie"}
            . {t("footerRights")}
          </p>
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            to="/admin"
            className="text-gray-600 hover:text-amber-400 transition-colors flex items-center gap-1"
          >
