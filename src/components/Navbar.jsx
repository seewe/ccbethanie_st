...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Main Navigation Bar */}
      <nav
        className={`w-full bg-white/98 backdrop-blur-md transition-all duration-300 ${
          isScrolled
            ? "py-2 sm:py-2.5 border-b border-gray-200/80"
            : "py-3 sm:py-3.5 border-b border-gray-100"
        }`}
      >
          ...
          <div className="lg:hidden border-t border-gray-200 bg-white px-4 pt-3 pb-6 space-y-2 shadow-lg animate-in slide-in-from-top-2 duration-200">
            <div className="py-2 border-b border-gray-100 text-xs text-amber-700 bg-amber-50 px-3 rounded flex items-center justify-between">
              ...
              <span className="text-gray-500">
                {language === "en" ? "Montreal, QC" : "Québec, QC"}
              </span>
            </div>
            ...
            <Link
              ...
              className={`block px-3 py-2 rounded-md text-base font-medium ${
                isActive("/")
                  ? "bg-amber-50 text-[#C9862C] font-bold"
                  : "text-gray-800"
              }`}
            >
              {t("navHome")}
